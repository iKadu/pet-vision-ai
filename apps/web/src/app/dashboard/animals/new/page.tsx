...
export default function NewAnimalPage() {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!name.trim() || createPet.isPending) return;
